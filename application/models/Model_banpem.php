<?php
class Model_banpem extends CI_Model {
    ...
    public function save_transuang($params = NULL)
    {
            $valid = true;

            $this->db->set($params);
            $valid = $this->db->insert('data_transuang');

        return $valid;

    }

    public function save_transbarang($params = NULL)
    {
            $valid = true;
            ...
            $valid = $this->db->insert('data_transbarang');
